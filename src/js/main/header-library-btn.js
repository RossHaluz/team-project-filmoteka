...
refs.libraryBtnQueue.addEventListener('click', onClickBtnQueue);
...
export function onClickBtnQueue(){
    refs.libraryBtnWatched.classList.remove('hedear__library--btn-active');
    refs.libraryBtnQueue.classList.add('hedear__library--btn-active')
}